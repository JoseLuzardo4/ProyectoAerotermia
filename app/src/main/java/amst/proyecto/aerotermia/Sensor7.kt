...
class Sensor7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_sensor7)
        ...
        speedometer = findViewById(R.id.termopar7)

        // Initialize Firebase Database reference
        databaseRef = FirebaseDatabase.getInstance().getReference("/sensor7/temperatura")
