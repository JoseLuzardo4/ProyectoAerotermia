...
class Sensor6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_sensor6)
        ...
        speedometer = findViewById(R.id.termopar6)

        // Initialize Firebase Database reference
        databaseRef = FirebaseDatabase.getInstance().getReference("/sensor6/temperatura")
